...
<head>
    ...
    <title>Medicare Hospitals | Contact us</title>
    <meta charset="utf-8">
...
<div class="card w-75">
  <div class="card-body">
    <h3 class="card-title" style="text-align:center; color:#0a4275;">Contact us</h3>
        <form name="sentMessage"  method="post">
                    <div class="control-group form-group">
                        <div class="controls">
                            <label>Full Name:</label>
                            <input type="text" class="form-control" id="fname" name="fullname" required data-validation-required-message="Please enter your name.">
